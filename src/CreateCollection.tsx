...
const fenecImages = [
  'https://www.endangeredwolfcenter.org/wp-content/uploads/2021/11/MJS_5861-Daisy_3-1.jpg',
  'https://img-ovh-cloud.zszywka.pl/1/0124/7823-baby-fennec-fox.jpg',
  'https://velonews.pl/uploads/wysiwyg/images/7587/4d9a37eb/428756.jpg',
  'https://media.gettyimages.com/photos/fennec-fox-picture-id114379692?s=2048x2048',
  'https://www.thesprucepets.com/thmb/d-El6j4ACqVfnriVu7NByjzJ4f0=/3798x3798/smart/filters:no_upscale()/fennec-fox-facts-1238644-hero-822ea8984d734f8cb5cfac05b74ab6c1.JPG'
]
...
export const CreateCollectionButton: React.FC<{
  ...
  const createCollection = async () => {
    ...
    try {
      ...
      console.log(arrayCreateTokens)
      console.log('sign all')
      const promise: Array<Promise<PendingTransaction>> = []
      for (const signedCreateTx of signedTxs) {
        const result = promise.push(aptosClient.submitSignedBCSTransaction(signedCreateTx))
